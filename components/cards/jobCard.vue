  ...
  <v-hover v-slot="{ hover }">
    ...
    >
      ...
      <div>
        ...
        <v-card-title class="text-subtitle-1 pt-0 pb-2 font-weight-medium pl-0">
          <v-img
            class="mr-3"
            contain
            max-height="64"
          ...
          <v-tab-item key="Description">
            <v-card-text>
              ...
              <v-row no-gutters>
                <v-col>
                  <div>
                    <v-icon small color="primary" class="mr-3">mdi-home</v-icon>
                    {{ jobData.city }}
                  </div>
                  <br />
                  <div>
                ...
                <v-col>
                  <div>
                    ...
                    <p class="timerCounter">
                      ...
                      {{
                        jobData.scoring.salary.holidays
                          | formatShortThousandNumber
                      }}
                      yearly
                    </p>
                  </div>
